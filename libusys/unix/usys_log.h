...
#define usys_log_err(fmt, ...)                                                 \
    usys_log(USYS_LOG_ERRO, "file: %s line: %d " fmt, __FILE__, __LINE__,      \
             __VA_ARGS__)

#define usys_log_warn(...) usys_log(USYS_LOG_WARN, __VA_ARGS__)
#define usys_log_ok(...) usys_log(USYS_LOG_OK, __VA_ARGS__)
